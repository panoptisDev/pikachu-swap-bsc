...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and PIKACHU pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and PIKACHU pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from OVE pool', data)
  }
