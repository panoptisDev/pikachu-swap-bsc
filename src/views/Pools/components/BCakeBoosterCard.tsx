...
export const BCakeBoosterCard = () => {
  ...
  const tooltipContent = (
    <>
      <Box mb="20px">
        {t(
          'Yield Boosters allow you to boost your farming yields by locking PIKACHU in the fixed-term staking PIKACHU pool. The more PIKACHU you lock, and the longer you lock them, the higher the boost you will receive.',
        )}
      </Box>
      <Box>
    ...
    return (
      <Box>
        ...
        <Text color="textSubtle" fontSize={12} mb="16px">
          {t('An active fixed-term PIKACHU staking position is required for activating farm yield boosters.')}
        </Text>
