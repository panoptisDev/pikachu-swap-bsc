...
export const DEFAULT_META: PageMeta = {
  title: 'WhaleHarvest',
  description:
    'A popular AMM on BSC by user count! Earn LAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by WhaleHarvest), NFTs, and more, on a platform you can trust.',
  image: 'https://panoptisdev.github.io/whaleharvest.github.io/lake_96.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    ...
    defaultTitleSuffix: t('WhaleHarvest'),
  }
}
