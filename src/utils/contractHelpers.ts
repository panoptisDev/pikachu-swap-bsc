...
import Launchpadv1Abi from 'config/abi/Launchpadv1.json'
import pointCenterIfo from 'config/abi/pointCenterIfo.json'
import ifoV3Abi from 'config/abi/ifoV3.json'
import lotteryV2Abi from 'config/abi/lotteryV2.json'
import masterChef from 'config/abi/masterchef.json'
import sousChef from 'config/abi/sousChef.json'
import wrappedBNB from 'config/abi/wrappedBnb.json'
...
export const getLaunchpadv1Contract = (address: string, signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(Launchpadv1Abi, address, signer)
}
...
export const getwrappedBNBContract = (address: string, signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(wrappedBNB, address, signer)
}
